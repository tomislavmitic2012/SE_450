...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            order1 = new Order("USER1", "GE", PriceFactory.makeLimitPrice("$21.59"), 250, [BUY]); // Replace "[BUY]" with YOUR BUY representation
	...
	tradable1 = order1;
        ...
        try {
            ...
            order1 = new Order("USER1", "GE", PriceFactory.makeLimitPrice("$21.59"), 0, [BUY]); // Replace "[BUY]" with YOUR BUY representation
        ...
        try {
            ...
            System.out.println("\t" + quote1.getQuoteSide([BUY])); // Replace "[BUY]" with YOUR BUY representation
            System.out.println("\t" + quote1.getQuoteSide([SELL])); // Replace "[SELL]" with YOUR SELL representation
        } catch (Exception ex) {
