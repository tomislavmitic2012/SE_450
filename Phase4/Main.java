...
public class Main {
    ...
    private static void doBadTests(String stockSymbol) {
        ...
        //            new Order(u1.getUserName(), "X11", PriceFactory.makeLimitPrice("$641.10"), 111, GlobalConstants.BookSide.BUY));
        //    System.out.println("Did not catch non-existent Stock error!");
        //} catch (Exception ex) {
    ...
    private static void doTradingScenarios(String stockSymbol) {
        try {
            ...
            //ProductService.getInstance().submitOrder(
            //        new Order(u1.getUserName(), stockSymbol, PriceFactory.makeLimitPrice("$641.10"), 111, GlobalConstants.BookSide.BUY));
            //ProductService.getInstance().submitOrder(
            //        new Order(u1.getUserName(), stockSymbol, PriceFactory.makeLimitPrice("$641.11"), 222, GlobalConstants.BookSide.BUY));
            //ProductService.getInstance().submitOrder(
            //        new Order(u1.getUserName(), stockSymbol, PriceFactory.makeLimitPrice("$641.12"), 333, GlobalConstants.BookSide.BUY));
            //ProductService.getInstance().submitOrder(
            //        new Order(u1.getUserName(), stockSymbol, PriceFactory.makeLimitPrice("$641.13"), 444, GlobalConstants.BookSide.BUY));
            //ProductService.getInstance().submitOrder(
            //        new Order(u1.getUserName(), stockSymbol, PriceFactory.makeLimitPrice("$641.14"), 555, GlobalConstants.BookSide.BUY));
            //System.out.println();
            ...
            //ProductService.getInstance().submitOrder(
            //        new Order(u2.getUserName(), stockSymbol, PriceFactory.makeLimitPrice("$641.16"), 111, GlobalConstants.BookSide.SELL));
            //ProductService.getInstance().submitOrder(
            //        new Order(u2.getUserName(), stockSymbol, PriceFactory.makeLimitPrice("$641.17"), 222, GlobalConstants.BookSide.SELL));
            //ProductService.getInstance().submitOrder(
            //        new Order(u2.getUserName(), stockSymbol, PriceFactory.makeLimitPrice("$641.18"), 333, GlobalConstants.BookSide.SELL));
            //ProductService.getInstance().submitOrder(
            //        new Order(u2.getUserName(), stockSymbol, PriceFactory.makeLimitPrice("$641.19"), 444, GlobalConstants.BookSide.SELL));
            //ProductService.getInstance().submitOrder(
            //        new Order(u2.getUserName(), stockSymbol, PriceFactory.makeLimitPrice("$641.20"), 555, GlobalConstants.BookSide.SELL));
            //System.out.println();
            ...
            //ProductService.getInstance().submitOrder(
            //        new Order(u2.getUserName(), stockSymbol, PriceFactory.makeLimitPrice("$641.15"), 105, GlobalConstants.BookSide.BUY));
            //System.out.println();
            ...
            //ProductService.getInstance().submitOrder(
            //        new Order(u1.getUserName(), stockSymbol, PriceFactory.makeMarketPrice(), 1750, GlobalConstants.BookSide.BUY));
            //System.out.println();
            ...
            //ProductService.getInstance().submitOrder(
            //        new Order(u1.getUserName(), stockSymbol, PriceFactory.makeLimitPrice(64130), 369, GlobalConstants.BookSide.BUY));
            //System.out.println();
            ...
            //ProductService.getInstance().submitOrder(
            //        new Order(u2.getUserName(), stockSymbol, PriceFactory.makeLimitPrice(64130), 369, GlobalConstants.BookSide.SELL));
            //System.out.println();

            //System.out.println("26) User " + u1.getUserName() + " enters a MKT BUY order, cancelled as there is no market");
            //ProductService.getInstance().submitOrder(
            //        new Order(u1.getUserName(), stockSymbol, PriceFactory.makeMarketPrice(), 456, GlobalConstants.BookSide.BUY));
            //System.out.println();

            //System.out.println("27) User " + u1.getUserName() + " enters a BUY order, Current Market received");
            //ProductService.getInstance().submitOrder(
            //        new Order(u1.getUserName(), stockSymbol, PriceFactory.makeLimitPrice("641.1"), 151, GlobalConstants.BookSide.BUY));
            //System.out.println();
            ...
            //ProductService.getInstance().submitOrder(
            //        new Order(u2.getUserName(), stockSymbol, PriceFactory.makeLimitPrice(64110), 51, GlobalConstants.BookSide.SELL));
            //System.out.println();
