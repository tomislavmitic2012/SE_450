...
/**
 * The Position class (for the "client" package) is used to hold an individual
 * users profit and loss information, including how much they have spent buying
 * stock, how much they gained or lost selling stock, and the value of the stock
 * they currently own.
 *
