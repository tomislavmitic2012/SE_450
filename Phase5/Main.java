...
public class Main {
    ...
    private static void runTests(String stock) {
        try {
            ...
            String rexO1 = users.get(0).submitOrder(stock, PriceFactory.makeLimitPrice("$40.00"), 100, GlobalConstants.BookSide.BUY);
            System.out.println();
            ...
            String o2 = users.get(2).submitOrder(stock, PriceFactory.makeLimitPrice("$40.50"), 135, GlobalConstants.BookSide.SELL);
            System.out.println();
            ...
            users.get(0).submitOrderCancel(stock, GlobalConstants.BookSide.BUY, rexO1);
            System.out.println();
            ...
            users.get(2).submitOrderCancel(stock, GlobalConstants.BookSide.SELL, o2);
            System.out.println();
            ...
            users.get(0).submitOrder(stock, PriceFactory.makeLimitPrice("$10.00"), 100, GlobalConstants.BookSide.BUY);
            System.out.println();
            ...
            users.get(2).submitOrder(stock, PriceFactory.makeLimitPrice("$10.00"), 150, GlobalConstants.BookSide.SELL);
            System.out.println();
            ...
            users.get(0).submitOrder(stock, PriceFactory.makeMarketPrice(), 75, GlobalConstants.BookSide.BUY);
            System.out.println();
